...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="Person">
        <person>
            ...
            <xsl:attribute name="birthDate"><xsl:value-of select="birthDate" /></xsl:attribute>
            ...
            <document>
                ...
                <xsl:attribute name="type"><xsl:value-of select="document/documentType" /></xsl:attribute>
                <xsl:attribute name="issueDate"><xsl:value-of select="document/issueDate" /></xsl:attribute>
            </document>
        </person>
    </xsl:template>
